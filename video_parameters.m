% Structs for each video
i=0;

% Video 1
i=i+1;
v(i).animal="A1";
v(i).basefilepath='Deep_Lab_Cut/Orig_Videos/MD200312_A_BD/A_WIN_20200326/A_WIN_20200326_18_15_04_ProDLC_resnet50_Full_TrackingApr17shuffle1_2400filtered.csv'; % path to original video data
v(i).trackpath=v(i).basefilepath;
%v(i).trackpath='Tracking Results/A1_edited.csv'; % path to edited coordinate track
v(i).track=readmatrix(v(i).trackpath);
...
i=i+1;
v(i).animal="A2";
v(i).basefilepath='Deep_Lab_Cut/Orig_Videos/MD200312_A_BD/A_WIN_20200327/A_WIN_20200327_18_20_59_ProDLC_resnet50_Full_TrackingApr17shuffle1_2400filtered.csv'; % path to original video data
v(i).trackpath=v(i).basefilepath;
...
i=i+1;
v(i).animal="B1";
v(i).basefilepath='Deep_Lab_Cut/Orig_Videos/MD200312_B_BD/B_WIN_20200327/B_WIN_20200327_13_40_18_ProDLC_resnet50_Full_TrackingApr17shuffle1_2400filtered.csv'; % path to original video data
v(i).trackpath=v(i).basefilepath;
...
i=i+1;
v(i).animal="B2";
v(i).basefilepath='Deep_Lab_Cut/Orig_Videos/MD200312_B_BD/B_WIN_20200328/B_WIN_20200328_19_27_06_ProDLC_resnet50_Full_TrackingApr17shuffle1_2400filtered.csv'; % path to original video data
v(i).trackpath=v(i).basefilepath;
